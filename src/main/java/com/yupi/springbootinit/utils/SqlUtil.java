...
public class SqlUtil {
     ...
     * 定义常用的 sql关键字
     */
    public static String SQL_REGEX = "and |extractvalue|updatexml|exec |insert |select |delete |update |drop |count |chr |mid |master |truncate |char |declare |or |+|user() |%|_";
    /**
    ...
    public static boolean isSqlInjection(String input) {
        return input != null && input.matches(SQL_INJECTION);
    }
